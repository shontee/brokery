...
class Login extends jigowatt_integration {
	...
	public function login() {
		...
		//clear user login
		$stmt = parent::query("DELETE FROM `onlineuser` WHERE loginid = '".$this->result['user_id']."';", $params);
		$stmt = parent::query("INSERT INTO `onlineuser` (`loginid` ,`sessionid` ,`timestamp` ,`ipaddress`) VALUES (:user_id, :sessionid, CURRENT_TIMESTAMP,:ip);", $params);
		...
		//sessionid
		$_SESSION['jigowatt']['sessionid'] = $rand_num;
